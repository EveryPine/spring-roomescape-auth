...
|------|--------|--------------------|----------------|----------|-----------------------------|
| 로그인  | POST   | `/api/auth/login`  | 200 OK         | 400, 401 | [상세](docs/API_SPEC.md#로그인)  |
| 로그아웃 | POST   | `/api/auth/logout` | 204 No Content | 400, 401 | [상세](docs/API_SPEC.md#로그아웃) |
...
| API         | Method | Path                                                                        | 성공 응답          | 주요 실패 응답                     | 상세                                      |
|-------------|--------|-----------------------------------------------------------------------------|----------------|------------------------------|-----------------------------------------|
| 회원가입        | POST   | `/api/members`                                                              | 201 Created    | 400, 409                     | [상세](docs/API_SPEC.md#사용자-회원가입)         |
